        ...
        getUserProfile: function (user_name, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            localVarPath = "/api/v1/user-profile";
                            localVarUrlObj = new URL(localVarPath, 'https://example.com');
                            if (configuration) {
                                baseOptions = configuration.baseOptions;
                            }
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            if (refresh_token === null || refresh_token === undefined) {
                                throw new base_1.RequiredError('refresh_token', 'Required parameter refresh_token was null or undefined when calling refreshToken.');
                            }
...
var AuthApi = /** @class */ (function (_super) {
     ...
     * @memberof AuthApi
     */
    AuthApi.prototype.authenticate = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
     ...
     * @memberof AuthApi
     */
    AuthApi.prototype.getUserProfile = function (user_name, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
     ...
     * @memberof AuthApi
     */
    AuthApi.prototype.refreshToken = function (refresh_token, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
