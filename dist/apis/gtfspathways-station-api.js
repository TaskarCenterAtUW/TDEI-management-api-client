...
exports.GTFSPathwaysStationApi = exports.GTFSPathwaysStationApiFactory = exports.GTFSPathwaysStationApiFp = exports.GTFSPathwaysStationApiAxiosParamCreator = void 0;
/* tslint:disable */
/* eslint-disable */
/**
 * TDEI Management API
 ...
 * @export
 */
exports.GTFSPathwaysStationApiAxiosParamCreator = function (configuration) {
    var _this = this;
    return {
        /**
         ...
         */
        createStation: function (body, options) {
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            if (body === null || body === undefined) {
                                throw new base_1.RequiredError('body', 'Required parameter body was null or undefined when calling createStation.');
                            }
                            localVarPath = "/api/v1/station";
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            if (stationId === null || stationId === undefined) {
                                throw new base_1.RequiredError('stationId', 'Required parameter stationId was null or undefined when calling setServiceStatus.');
                            }
 ...
 * @export
 */
exports.GTFSPathwaysStationApiFp = function (configuration) {
    return {
        /**
         * Creates a GTFS Pathways station in the TDEI system. Returns the id for the newly created pathways station.
         * @summary Creates a GTFS Pathways station in the TDEI system
        ...
        createStation: function (body, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.GTFSPathwaysStationApiAxiosParamCreator(configuration).createStation(body, options)];
                        case 1:
 ...
 * @export
 */
exports.GTFSPathwaysStationApiFactory = function (configuration, basePath, axios) {
    return {
        /**
         * Creates a GTFS Pathways station in the TDEI system. Returns the id for the newly created pathways station.
         * @summary Creates a GTFS Pathways station in the TDEI system
        ...
        createStation: function (body, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, exports.GTFSPathwaysStationApiFp(configuration).createStation(body, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
 ...
 * @extends {BaseAPI}
 */
var GTFSPathwaysStationApi = /** @class */ (function (_super) {
    __extends(GTFSPathwaysStationApi, _super);
    function GTFSPathwaysStationApi() {
     ...
     */
    GTFSPathwaysStationApi.prototype.createStation = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, exports.GTFSPathwaysStationApiFp(this.configuration).createStation(body, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
    ...
    return GTFSPathwaysStationApi;
}(base_1.BaseAPI));
exports.GTFSPathwaysStationApi = GTFSPathwaysStationApi;
